...
<link rel="stylesheet" href="../css/login.css">
        <form action="../server/user_authentication.php" class="form-floating" method="POST">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="submit" id="sub-btn" value="login"  name="login" class="btn btn-primary btn-block mb-4"> 
